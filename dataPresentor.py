...
class January(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r"\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\january.xlsx")
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class Feburary(tk.Frame):
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\feburary.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class March(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\march.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class April(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\april.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class May(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\may.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class June(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\june.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class July(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\july.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class August(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\august.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class September(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\september.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class October(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\october.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class November(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\november.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
...
class December(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook(r'\\tsclient\P\Gateshead Ops\NS36 Workaround\CIM\Team Members\Faiz\Reporting\genesisOne\december.xlsx')
        sheet = wb["Sheet1"]
        name=[]
        iteration = []
        timeTaken = []
