...
def calculateTime(day,processName,Month):
    ...
    for fileName in range(0,len(array)):
        with open('C:\\Users\\aquibf632\\Desktop\\'+processName+'\\'+array[fileName]) as f:
            for line in f:
...
def updateExcelTwo(processName,Month):
    wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisTwo\\"+Month+"\\"+processName+".xlsx")
    sheet = wb.get_sheet_by_name("Sheet1") 
        ...
        if(month < currentMonth):
            if(lastDay<currentDay):
                for i in range(int(lastDay)+1,32):
                    ...
                    wb.save("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisTwo\\"+Month+"\\"+processName+".xlsx")
...
def updateExcelOne(processName,Month):
    wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\"+Month+".xlsx")
    sheet = wb.get_sheet_by_name("Sheet1")
    for i in range(2,sheet.max_row+1):
        if(sheet.cell(row=i,column=1).value == processName):
            ...
            wb.save("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\"+Month+".xlsx")
...
class January(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\january.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
        timeTaken = []
...
class Feburary(tk.Frame):
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\feburary.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class March(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("C\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\march.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class April(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\april.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class May(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\may.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class June(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\june.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class July(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\july.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class August(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\august.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class September(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\september.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class October(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\october.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class November(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\november.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
...
class December(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        wb = openpyxl.load_workbook("\\Worldpay.Local\\Homedrives\\INI-A-F\\AQUIBF632\\Apps\\Microsoft\\Desktop\\genesisOne\\december.xlsx")
        sheet = wb.get_sheet_by_name("Sheet1")
        name=[]
        iteration = []
